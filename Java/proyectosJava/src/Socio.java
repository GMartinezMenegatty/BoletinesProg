...
public class Socio extends Persoa implements Comparable<Socio>{
    ...
    public Socio(String nome, String dni, int edad, double estatura, String dataAlta){
        super(nome,dni,edad, estatura);
    ...
    public static void main(String args[]){
        Socio s = new Socio("Sergio", "123D",18,1.70,"10/02/2020" );
